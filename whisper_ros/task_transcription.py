...
def transcribe_audio():
    print('transcribing')
    result = subprocess.run(["/home/kensuke/whisper.cpp/main", "-f", "TTR_prompt.wav" , "-np", "-m", "/home/kensuke/whisper.cpp/models/ggml-base.en.bin"], capture_output=True, text=True)
